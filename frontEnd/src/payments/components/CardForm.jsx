  ...
  return (
    ...
    <div className="card-form__inner">
      ...
      <div className="card-input">
        <label htmlFor="cardNumber" className="card-input__label">Número do Cartão</label>
        <input
          type="tel"
          id="cardNumber"
      ...
      <div className="card-input">
        <label htmlFor="cardName" className="card-input__label">Títular do Cartão</label>
        <input
          type="text"
          id="cardName"
          maxLength={15}
      ...
      <div className="card-form__row">
        <div className="card-form__col">
          <div className="card-form__group">
            <label htmlFor="cardMonth" className="card-input__label">Data de Vencimento</label>
            <select
              ...
              defaultValue={0}
            >
              <option disabled value={0}>Mês</option>
            ...
            <select
              ...
              defaultValue={1}
            >
              <option disabled value={1} >Ano</option>
